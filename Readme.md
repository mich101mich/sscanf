...
The first allows for autocomplete while typing, syntax highlighting and better error messages
...
`scanf!()` call, because the [`Error`](https://docs.rs/sscanf/0.2.0/sscanf/enum.Error.html)
type borrows from it and using [`str`](https://doc.rust-lang.org/std/primitive.str.html)

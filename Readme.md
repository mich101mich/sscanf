...
The second mirrors the [captured identifiers in format strings (since 1.58)](https://blog.rust-lang.org/2022/01/13/Rust-1.58.0.html#captured-identifiers-in-format-strings).
...
Procedural macros don't have reliable type information and can only compare types by name. This means
